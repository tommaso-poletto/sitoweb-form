...
interface StepTransitionChallengesSolutionsProps {
    onContinue: () => void;
}

export const StepTransitionChallengesSolutions = ({ onContinue }: StepTransitionChallengesSolutionsProps) => {
    useEffect(() => {
    ...
    return (
        ...
        >
            <div className="max-w-md w-full flex flex-col items-center">
                ...
                >
                    È frustrante, vero? Ecco perché le soluzioni attuali non bastano.
                </motion.h2>
            </div>
