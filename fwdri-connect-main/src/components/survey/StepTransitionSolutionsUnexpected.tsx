...
interface StepTransitionSolutionsUnexpectedProps {
    onContinue: () => void;
}

export const StepTransitionSolutionsUnexpected = ({ onContinue }: StepTransitionSolutionsUnexpectedProps) => {
    useEffect(() => {
    ...
    return (
        ...
        >
            <div className="max-w-md w-full flex flex-col items-center">
                ...
                >
                    Spesso paghiamo con il tempo ciò che non paghiamo in denaro.
                </motion.h2>
            </div>
