...
interface StepTransitionDietImpactProps {
    onContinue: () => void;
}

export const StepTransitionDietImpact = ({ onContinue }: StepTransitionDietImpactProps) => {
    useEffect(() => {
    ...
    return (
        ...
        >
            <div className="max-w-md w-full flex flex-col items-center">
                ...
                >
                    In Europa siamo in 220 milioni a dover controllare cosa mangiamo.
                </motion.p>
            </div>
