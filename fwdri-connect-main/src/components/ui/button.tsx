...
const buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
  variants: {
    variant: {
      ...
      // Hero CTA - Persimmon with glow effect
      hero: "bg-secondary text-secondary-foreground hover:bg-persimmon-dark rounded-full shadow-glow hover:shadow-xl hover:scale-105 font-bold",
      // Hero outline variant
      heroOutline: "border-2 border-secondary bg-transparent text-secondary hover:bg-secondary hover:text-secondary-foreground rounded-full font-bold",
      // Nav link style
      nav: "text-foreground-muted hover:text-foreground bg-transparent font-medium"
    },
    size: {
